...
internal object ColorDarkTokens {
    ...
    val Primaryer = FidoPaletteTokens.PrimaryDarker
    val Primaryest = FidoPaletteTokens.PrimaryDarkest

    val SecondaryMain = FidoPaletteTokens.SecondaryMain
    val Secondary = FidoPaletteTokens.SecondaryDark
    val Secondaryer = FidoPaletteTokens.SecondaryDarker
    val Secondaryest = FidoPaletteTokens.SecondaryDarkest

    val Neutral_TextColors_HighEmp = FidoPaletteTokens.Neutral_TextColorsWhite_HighEmp
    val Neutral_TextColors_MidEmp = FidoPaletteTokens.Neutral_TextColorsWhite_MidEmp
    val Neutral_TextColors_LowEmp = FidoPaletteTokens.Neutral_TextColorsWhite_LowEmp
